...
train_df_name = "train_split_segmented50.csv"
...
checkpoint = ModelCheckpoint(
    "/content/drive/MyDrive/individual projects/densenet121_segmented50_best.h5",
...
history_df.to_csv("/content/drive/MyDrive/individual projects/densenet121_segmented50_history.csv", index=False)
...
cm_df.to_csv("/content/drive/MyDrive/individual projects/densenet121_segmented50_confusion_matrix.csv")
print("Confusion matrix saved successfully!")

# Save normalized confusion metrics
cm_norm_df = pd.DataFrame(cm_norm, index=class_labels, columns=class_labels)
cm_norm_df.to_csv("/content/drive/MyDrive/individual projects/densenet121_segmented50_cm_norm.csv")
print("Normalized confusion matrix saved successfully!")

# Save per class metrics table
per_class_df.to_csv("/content/drive/MyDrive/individual projects/densenet121_segmented50_per_class_metrics.csv", index=False)
...
if os.path.exists(results_path):
    ...
    mask = (existing_df["model"] == "DenseNet121_Segmented") & (existing_df["data_size"] == "50%")
    if mask.any():
